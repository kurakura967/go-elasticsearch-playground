...
def trainModel(training_set, out, features=None, kcv=None, ranker=6,
    ...
    cmd = '/Users/hiroki.kurasawa/.sdkman/candidates/java/current/bin/java -jar {} -ranker {} -shrinkage {} -metric2t {} -tree {} -bag {} -leaf {} -frate {} -srate {} -train {} -save {} '.format(
    ...
    return parse_training_log(process.stdout)
